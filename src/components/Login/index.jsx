...
export default function Login() {
  ...
  const { user, loginAppError, loginServerError, loading } = storeData;
                ...
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-gray-300 shadow-lg rounded-lg">
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="text-red-400 mb-10">
                      {loginAppError || loginServerError ? (
                        <h1>
                          {loginServerError} {loginAppError}
                        </h1>
                      ) : null}
                    </div>
                    ...
                    <div className="flex items-center pl-6 mb-2 border border-gray-50 bg-white rounded-full">
                      <span className="inline-block pr-3 border-r border-gray-50">
                        <svg
                          className="w-5 h-5"
                          width="20"
                    ...
                    {loading ? (
                      <button
                        type="submit"
                        className="py-4 w-full bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200 mt-10"
                      >
                        Loading ...
                      </button>
                    ) : (
                  ...
                  <p className="text-center text-sm mt-2 text-black font-semibold">
                    Don't have account?{" "}
