...
export default function Register() {
  ...
  const { registered, appError, serverError, loading, user } = storeData;
  ...
  return (
    <section className="relative py-10 2xl:py-20 bg-gray-800 overflow-hidden min-h-screen">
          ...
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                ...
                <h2 className="mt-8 mb-12 text-5xl font-bold font-heading text-white leading-snug">
